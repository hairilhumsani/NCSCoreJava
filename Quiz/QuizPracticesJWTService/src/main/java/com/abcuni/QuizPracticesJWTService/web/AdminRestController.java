...
public class AdminRestController {
	...
	{
		ResponseEntity<Question> result = restTemplate.postForEntity("http://QUIZPRACTICES-QUESTION/api/questions/addQuestion", q,Question.class);
		return result;
	}
	...
	{
		ResponseEntity<Question[]> result = restTemplate.getForEntity("http://QUIZPRACTICES-QUESTION/api/questions/getAll", Question[].class);
	...
	{
		ResponseEntity<Question[]> result = restTemplate.getForEntity("http://QUIZPRACTICES-QUESTION/api/questions/getByCategory/" + category, Question[].class);
		return Arrays.asList(result.getBody());
	}
	...
	{
		ResponseEntity<Question> result = restTemplate.getForEntity("http://QUIZPRACTICES-QUESTION/api/questions/getById/" + id, Question.class);
	...
	{
		ResponseEntity <Users[]> result=restTemplate.getForEntity("http://QUIZPRACTICES-USER/api/users/getAll",Users[].class);
		return Arrays.asList(result.getBody());
	}
	...
	{
		ResponseEntity <Users[]> result=restTemplate.getForEntity("http://QUIZPRACTICES-USER/api/users/getUsersByRole/" + role,Users[].class);
		return Arrays.asList(result.getBody());
	}
	...
	{
		ResponseEntity<Tests[]> result = restTemplate.getForEntity("http://QUIZPRACTICES-TEST/api/tests/getById/" + id, Tests[].class);
		return Arrays.asList(result.getBody());
	}
